...
public class WeatherController extends AppCompatActivity {
    ...
    private final String APP_ID = "8e7b63d4e3498aded9a8135084330265";
...
private void letsDoSomeNetworking(RequestParams params){
    ...
    client.get(WEATHER_URL,params,new JsonHttpResponseHandler(){
       ...
       public void onSuccess(int statusCode, Header[] headers, JSONObject response){
           ...
           WeatherController.this.updateUI(wdm);
    ...
    private void updateUI(WeatherDataModel wdm) {
        mTemperatureLabel.setText(wdm.getmTemperature());
        mCityLabel.setText(wdm.getmCity());
        int resourceID=getResources().getIdentifier(wdm.getmIconName(),"drawable",getPackageName());
